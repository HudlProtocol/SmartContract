...
contract HudlProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "HUDL PROTOCOL";
    string private _symbol = "HUDL";
    ...
    uint256 public burnBasePercent = 10;

    uint256 public _liquidityFee = 5;
    uint256 private _previousLiquidityFee = _liquidityFee;

    // monthly burn token (1M token will be burn for every 30 days)
    address payable public burnAddress = 0xF490839301fB95158560F4D70D64764A470F3a3F;        
    uint256 _burnPerMonth           = 1 * 10**6 * 10**9;
    ...
    uint256 public maxBurnLimit     = 2 * 10**6 * 10**9;
    ...
    function findTenPercent(uint256 value) public view returns (uint256){
      uint256 roundValue = value.ceil(burnBasePercent);
      uint256 TenPercent = roundValue.mul(burnBasePercent).div(100);
      return TenPercent;
    }
    ...
    function monthlyTokenBurn() public returns (bool) {
        ...
        _tTotal = _tTotal.sub(toNextBurn);
